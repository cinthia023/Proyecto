...
@section('content')
    <form class="form-group" method="POST" action="{{action('CuharonController@update', $cucharons->id)}}"
    ...
    @csrf
     <div clas="form-group">
        ...
        <input type="text" name="entrada_cucharon" value="{{$cucharons->entrada_cucharon}}"class="form-control">
